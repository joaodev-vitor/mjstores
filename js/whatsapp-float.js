/* =========================================================
   ...
   Aparece em todas as páginas (exceto o painel admin)
   ========================================================= */
...
(function () {
    ...
    var MENSAGEM = 'Olá! Vim do site MJ Stores e gostaria de mais informações.';

    var link = 'https://wa.me/' + NUMERO + '?text=' + encodeURIComponent(MENSAGEM);

    /* -----------------------------------------
       Injeta os estilos (uma vez só)
       ----------------------------------------- */
    ...
    btn.setAttribute('aria-label', 'Falar com MJ Stores pelo WhatsApp');
    ...
    btn.innerHTML =
        ...
        '</svg>' +
        '<span class="wa-float-tooltip">Fale conosco</span>';
